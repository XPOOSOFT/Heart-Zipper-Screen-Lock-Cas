...
import livewallpaper.aod.screenlock.zipper.ads_manager.splash_interstitial.callbacks.isInterLoading
import livewallpaper.aod.screenlock.zipper.ads_manager.splash_interstitial.callbacks.mInterstitialAd
    ...
    fun loadInterstitialAd(
        ...
        try {
            if (mInterstitialAd == null) {
                ...
                InterstitialAd.load(
                    activity,
                    if (isDebug()) "ca-app-pub-3940256099942544/1033173712" else interId,
